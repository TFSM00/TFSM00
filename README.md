...
- [Efficient Frontier Calculator Web App](https://tfsm00-markowitz-efficient-frontier-efficient-frontier-foagx5.streamlitapp.com/) - [Backup Link w/ 30 second load time](https://efficient-frontier-calculator.herokuapp.com/)
- [Black-Scholes Option Pricing Model Calculator Web App](https://tfsm00-black-scholes-calculator-bsm-streamlit-rm6hsi.streamlitapp.com/) - [Backup Link w/ 30 second load time](https://black-scholes-calculator.herokuapp.com/)
